  ...
  let resp = await axios({
    ...
    data: {
      url: encodeURIComponent(
        "http://i.waimai.meituan.com/ajax/v8/poi/food?_token=" + token
      ),
      params: {
        wm_poi_id: id,
        uuid:
          "EY-OMKnhbOGz_6vx4if6a40YX74q6C5oAKCH06EaIMDRAi7FCTXgzITkm1jGsfxE",
        platform: "3",
        partner: "4",
        userid: "280770501",
...
export const addSelectItemAction = obj => {
  return {
    type: ADD_SELECTI_ITEM,
    obj: obj
  };
};
export const minusSelectItemAction = obj => {
  return {
